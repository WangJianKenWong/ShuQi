...
//    appearance.shadowImage = [UIImage imageNamed:@"line"];
    appearance.shadowImage = [self imageWithColor:[UIColor colorWithHexString:@"D8D8D8"] size:CGSizeMake(self.view.frame.size.width, 0.5)];
    //（色号16进制） 导航背景颜色
    ...
    //导航文字颜色
    textAttribute[NSForegroundColorAttributeName] = [UIColor colorWithHexString:@"333333"];
    //导航标题文字大小
    textAttribute[NSFontAttributeName] = [UIFont boldSystemFontOfSize:20];

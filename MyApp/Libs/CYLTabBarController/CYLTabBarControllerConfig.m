...
- (NSArray *)tabBarItemsAttributesForController {
    NSDictionary *firstTabBarItemsAttributes = @{
                                                 ...
                                                 CYLTabBarItemImage : @"ic_menu_changpian_normal",  /* NSString and UIImage are supported*/
                                                 CYLTabBarItemSelectedImage : @"ic_menu_changpian_select", /* NSString and UIImage are supported*/
                                                 };
    NSDictionary *secondTabBarItemsAttributes = @{
                                                  CYLTabBarItemTitle : @"短片",
                                                  CYLTabBarItemImage : @"ic_menu_duanpian_normal",
                                                  CYLTabBarItemSelectedImage : @"ic_menu_duanpian_select",
                                                  };
    NSDictionary *thirdTabBarItemsAttributes = @{
                                                 CYLTabBarItemTitle : @"发现",
                                                 CYLTabBarItemImage : @"ic_menu_discover_normal",
                                                 CYLTabBarItemSelectedImage : @"ic_menu_discover_select",
                                                 };
    NSDictionary *fourthTabBarItemsAttributes = @{
                                                  CYLTabBarItemTitle : @"收藏",
                                                  CYLTabBarItemImage : @"ic_menu_collect_normal",
                                                  CYLTabBarItemSelectedImage : @"ic_menu_collect_select"
                                                  };
    NSDictionary *fifthTabBarItemsAttributes = @{
                                                  CYLTabBarItemTitle : @"会员",
                                                  CYLTabBarItemImage : @"ic_menu_vip_normal",
                                                  CYLTabBarItemSelectedImage : @"ic_menu_vip_select"
                                                  };
...
- (void)customizeTabBarAppearance:(CYLTabBarController *)tabBarController {
    ...
    normalAttrs[NSForegroundColorAttributeName] = [UIColor colorWithHexString:@"BBBBBB"];
    
    // set the text color for selected state
    // 选中状态下的文字属性
    NSMutableDictionary *selectedAttrs = [NSMutableDictionary dictionary];
    selectedAttrs[NSForegroundColorAttributeName] = [UIColor colorWithHexString:@"FF0000"];

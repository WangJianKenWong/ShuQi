...
//        self.layer.borderWidth = 0.5;
        ...
        _titleSelectedColor = [UIColor colorWithHexString:@"#FF0000"];
        _titleFont = 14;
    }
    return self;
}
...
//        creat button
        ...
        btn.frame =  CGRectMake(totalWidth, 14, btnW, 30);
        ...
        if (i == 0) {
            btn.selected = YES;
            btn.backgroundColor = [UIColor colorWithHexString:@"#FFE0E0"];
            ViewRadius(btn, btn.bounds.size.height*0.5);
...
- (void)titleButtonSelected:(UIButton *)btn {
    ...
    [self.selectedBtn setTitleColor:_titleColor forState:UIControlStateNormal];
    [self.selectedBtn setTitleColor:_titleSelectedColor forState:UIControlStateSelected];
    [self.selectedBtn.titleLabel setFont:[UIFont systemFontOfSize:_titleFont]];
    ...
    btn.backgroundColor = [UIColor colorWithHexString:@"#FFE0E0"];
    ViewRadius(btn, btn.bounds.size.height*0.5);
    [btn.titleLabel setFont:[UIFont boldSystemFontOfSize:_titleFont]];
    self.selectedBtn = btn;
